...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey('User', verbose_name="销售", related_name='customers', blank=True, null=True, on_delete=models.CASCADE, limit_choices_to={"depart_id":1})
    ...
    def get_status(self):
        ...
        return mark_safe("<span style='background-color:%s;color:white;padding:4px;display:inline-block;width:90px'>%s</span>"%(status_color[self.status],self.get_status_display()))
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey("crm.User", verbose_name="跟进人", related_name='records', on_delete=models.CASCADE)
...
class ClassStudyRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='User', limit_choices_to={"depart_id": 1002}, on_delete=models.CASCADE)
